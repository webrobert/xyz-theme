...
<section class="sm:min-h-screen flex items-center">
	<div class="my-8 grid grid-cols-12 mx-8 sm:mx-12 xl:ml-20" style="margin-bottom: 20vh">
        ...
        <ul class="social text-xl xl:text-2xl flex flex-col justify-end gap-2 lg:ml-12
                   ...
                   mt-12 sm:mt-0">
            <li>
                <a href="https://twitter.com/webrobert"
                   target="_blank" class="underline decoration-solid">Twitter</a>
            </li>
            <li>
                <a href="https://www.linkedin.com/in/rwayne/"
                   target="_blank" class="underline decoration-solid">LinkedIn</a>
            </li>
            <li>
                <a href="https://vero.co/webrobert"
                   target="_blank" class="underline decoration-solid">Vero</a>
            </li>
        </ul>
    </div>
</section>
